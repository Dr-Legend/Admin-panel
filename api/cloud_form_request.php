...
$ry=$PDO->db_query("insert into #_cloud_form set firstName='".$firstName."',middleName='".$middleName."',lastName='".$lastName."',contact_no='".$contact_no."',email='".$email."',address='".$address."',amount='".$amount."',country='".$country."'");
