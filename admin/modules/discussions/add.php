...
<div class="card mb-3">
  ...
  <div class="card-body">
    ...
    <div class="form-group row border-bottom pb-3">
      <label class="col-12 col-md-3" for="heading">Discussion Title<span class="text-danger">*</span></label>
      <div class="col-12 col-md-9">
      <input type="text" name="name" data-parsley-trigger="change" value="<?=$name?>" required class="form-control" data-parsley-required-message="Please insert Discussion Title">
      </div>
    </div>
   <div class="form-group row border-bottom pb-3">
      <label class="col-12 col-md-3">Discussion Date</label>
      <div class="col-12 col-md-9">
      <input type="text" name="discussionDate" data-parsley-trigger="change" value="<?=$discussionDate?>" required  class="form-control datepicker" data-parsley-required-message="Please insert discussion Date">
      </div>
    </div>
