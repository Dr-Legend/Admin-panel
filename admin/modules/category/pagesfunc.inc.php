...

{
...

	 {
	        ...
	        $query=parent::db_query("select * from #_".tblName." where name ='".$name."'"); 
...

	 {
	       ...
	       $query=parent::db_query("select * from #_".tblName." where name ='".$name."' and pid!='".$updateid."'"); 
...

	 {
...

		   {
				 ...
				 @unlink(UP_FILES_FS_PATH."/category/".$delete_image);

				 @unlink(UP_FILES_FS_PATH."/category/thumb/".$delete_image);
