...
<div class="card mb-3">
  ...
  <div class="card-body">
    ...
    <div class="form-group row border-bottom pb-3">
      <label class="col-12 col-md-3" for="heading">Title<span class="text-danger">*</span></label>
   ...
   <div class="form-group row border-bottom pb-3">
      <label class="col-12 col-md-3">Blog Date</label>
      <div class="col-12 col-md-9">
      <input type="text" name="blogDate" data-parsley-trigger="change" value="<?=$blogDate?>"  class="form-control datepicker" data-parsley-required-message="Please insert Blog Date">
      </div>
    </div>
