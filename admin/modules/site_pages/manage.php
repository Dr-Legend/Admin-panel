        ...
        <table width="100%" class="table table-bordered table-striped manage-table"  id="sort" cellpadding="0" cellspacing="0">
          <thead>
            <tr class="tbl-head">
              ...
              <th width="32%" class="noPad2"> <a href="<?=$ADMIN->iurl($comp)?>&fld=heading<?=(($otype=='asc')?"&otype=desc":'&otype=asc')?>" <?=(($fld=='heading')?'class="selectedTab"':'')?>><span <?=(($otype=='asc')?'class="des"':'class="asc"')?>> Heading</span></a> </th>
