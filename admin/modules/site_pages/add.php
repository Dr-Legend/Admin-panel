...
<div class="card mb-3">
  ...
  <div class="card-body">
    ...
    <div class="form-group row border-bottom pb-3">
            <label class="col-12 col-md-3"> Show On Footer<span class="text-danger">*</span></label>
            <div class="col-12 col-md-9">
            <select name="footer"  class="form-control" data-parsley-trigger="change" data-parsley-required-message="Footer Status is required!" required>
            <option  value="">-------Select Status------</option>
            <option value="1" <?=($footer==1)?'selected="selected"':''?>  >Active</option>
            <option value="0" <?=(isset($footer) && $footer==0)?'selected="selected"':''?>>Inactive</option>
            </select>
            </div>
            </div>
    <div class="form-group row border-bottom pb-3">
            <label class="col-12 col-md-3"> Show On Header<span class="text-danger">*</span></label>
            <div class="col-12 col-md-9">
            <select name="onheader"  class="form-control" data-parsley-trigger="change" data-parsley-required-message="Header Status is required!" required>
            <option  value="">-------Select Status------</option>
            <option value="1" <?=($onheader==1)?'selected="selected"':''?>  >Active</option>
            <option value="0" <?=(isset($onheader) && $onheader==0)?'selected="selected"':''?>>Inactive</option>
            </select>
            </div>
            </div>        
    <div class="form-group row border-bottom pb-3">
