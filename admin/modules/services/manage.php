  ...
  ?>
            <tr class="<?=$css?>" id="recordsArray_<?=$pid?>">
              ...
              <td><?php if($subpage_id==0){?>
                <a href="index.php?comp=services&subpage_id=<?=$pid?>">Sections (
                <?=$PDO->getSingleresult("select count(*) from #_services where subpage_id='".$pid."'")?>
                ) </a>
                <?php }?>
                <?php if($section==3){?>
                <a href="index.php?comp=services&subpage_id=<?=$pid?>">Tabs (
                <?=$PDO->getSingleresult("select count(*) from #_services where subpage_id='".$pid."'")?>
                ) </a>
                <?php }?></td>
