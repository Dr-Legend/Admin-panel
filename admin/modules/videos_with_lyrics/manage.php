        ...
        <table width="100%" class="table table-bordered table-striped manage-table"  id="sort" cellpadding="0" cellspacing="0">
          <thead>
            <tr class="tbl-head">
              ...
              <th width="36%" class="noPad2"> <a href="<?=$ADMIN->iurl($comp)?>&fld=name<?=(($otype=='asc')?"&otype=desc":'&otype=asc')?>" <?=(($fld=='name')?'class="selectedTab"':'')?>><span <?=(($otype=='asc')?'class="des"':'class="asc"')?>> Video Title</span></a> </th>
                <th width="16%" class="noPad2"> <a href="<?=$ADMIN->iurl($comp)?>&fld=youtubevideoid<?=(($otype=='asc')?"&otype=desc":'&otype=asc')?>" <?=(($fld=='youtubevideoid')?'class="selectedTab"':'')?>><span <?=(($otype=='asc')?'class="des"':'class="asc"')?>> Youtube Video Id</span></a> </th>
