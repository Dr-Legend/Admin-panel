...
<div class="card mb-3">
  ...
  <div class="card-body">
    ...
    <div class="form-group row border-bottom pb-3">
      <label class="col-12 col-md-3" for="heading">Mission Title<span class="text-danger">*</span></label>
   ...
   <div class="form-group row border-bottom pb-3">
      <label class="col-12 col-md-3">Mission Date</label>
      <div class="col-12 col-md-9">
      <input type="text" name="missionDate" data-parsley-trigger="change" value="<?=$missionDate?>"  class="form-control datepicker" data-parsley-required-message="Please insert mission Date">
      </div>
    </div>
 <div class="form-group row border-bottom pb-3">
      <label class="col-12 col-md-3">Mission Time</label>
      <div class="col-12 col-md-9">
      
      <input type="text" name="missionTime" data-parsley-trigger="change" value="<?=$missionTime?>"  class="form-control timepicker" data-parsley-required-message="Please insert mission Time">
      </div>
    </div>
    <div class="form-group row border-bottom pb-3">
