...

{
...

	 {
	        ...
	        $query=parent::db_query("select * from #_".tblName." where name ='".$name."' and bible_id='".$bible_id."' "); 
...

	 {
	       ...
	       $query=parent::db_query("select * from #_".tblName." where name ='".$name."' and pid!='".$updateid."' and bible_id='".$bible_id."' "); 
...

	 {
...

		{
		   ...
		   $wh=" and (name like '%".$search_data."%' or body like '%".$search_data."%' or paragraph like '%".$search_data."%') ";	
