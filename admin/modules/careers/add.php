...
<div class="card mb-3">
  ...
  <div class="card-body">
    ...
    <?php if($subpage_id>0){?>
    <div class="form-group row border-bottom pb-3">
      <label for="Profile " class="col-12  col-md-3">Profile<span class="text-danger">*</span></label>
      <div class="col-12 col-md-9">
      <input type="text" name="profile" data-parsley-trigger="change" value="<?=$profile?>" required class="form-control" data-parsley-required-message="Please insert  Profile">
      </div>
    </div>
    <div class="form-group row border-bottom pb-3">
      <label for="Function" class="col-12  col-md-3">Function<span class="text-danger">*</span></label>
      <div class="col-12 col-md-9">
      <input type="text" name="function" data-parsley-trigger="change" value="<?=$function?>" required class="form-control" data-parsley-required-message="Please insert  Function ">
      </div>
    </div>
    <div class="form-group row border-bottom pb-3">
      <label for="Location " class="col-12  col-md-3">Location <span class="text-danger">*</span></label>
      <div class="col-12 col-md-9">
      <input type="text" name="location" data-parsley-trigger="change" value="<?=$location?>" required class="form-control" data-parsley-required-message="Please insert  Location">
      </div>
    </div>
    <div class="form-group row border-bottom pb-3">
      <label for="Experience" class="col-12  col-md-3">Experience<span class="text-danger">*</span></label>
      <div class="col-12 col-md-9">
      <input type="text" name="experience" data-parsley-trigger="change" value="<?=$experience?>" required class="form-control" data-parsley-required-message="Please insert  Experience">
      </div>
    </div>
    <div class="form-group row border-bottom pb-3">
      <label for="EducationalQualification :" class="col-12  col-md-3">Educational Qualification<span class="text-danger">*</span></label>
      <div class="col-12 col-md-9">
      <input type="text" name="educqualif" data-parsley-trigger="change" value="<?=$educqualif?>" required class="form-control" data-parsley-required-message="Please insert  Experience">
      </div>
    </div>
    <div class="form-group row border-bottom pb-3">
      <label class="col-12 col-md-3" for="responsibilities">Responsibilities <!-- <span class="text-danger">*</span> --></label>
      <div class="col-12 col-md-9">
  ...
  <option value="0" <?=(isset($showhdr) && $showhdr==0)?'selected="selected"':''?>>Inactive</option>
    ...
    <?php }?>
    <div class="form-group row border-bottom pb-3">
      <label class="col-12 col-md-3" for="status">Status<span class="text-danger">*</span></label>
      <div class="col-12 col-md-9">
