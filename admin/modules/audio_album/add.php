...
<div class="card mb-3">
  ...
  <div class="card-body">
    <div class="form-group row border-bottom pb-3">
      <label for="emailAddress" class="col-12  col-md-3">Title<span class="text-danger">*</span></label>
      <div class="col-12 col-md-9">
      <input type="text" name="name" data-parsley-trigger="change" value="<?=$name?>" required class="form-control" data-parsley-required-message="Please insert Title">
      </div>
    </div>
   ...
   <div class="form-group row border-bottom pb-3">
      ...
      <div class="col-12 col-md-9">
      <input type="text" name="albumDate" data-parsley-trigger="change" value="<?=$albumDate?>" required  class="form-control datepicker" data-parsley-required-message="Please insert Date">
      </div>
    </div>
    <div class="form-group row border-bottom pb-3">
      <label class="col-12 col-md-3" for="emailAddress">Image</label>
      <div class="col-12 col-md-9">
