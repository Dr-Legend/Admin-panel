...
//print_r($data); exit;
	...
	while($rows=parent::db_fetch_array($ry)){
		...
		parent::pushnoti($rows['fcmid'],$names, 'Image added into Gallery!');
	}
...

	 {
	       ...
	       $query=parent::db_query("select * from #_".tblName." where name ='".$name."' and pid!='".$updateid."' and subpage_id='".$subpage_id."' "); 
...

	 {
...

		   {
				 ...
				 @unlink(UP_FILES_FS_PATH."/gallery/".$delete_image);

				 @unlink(UP_FILES_FS_PATH."/gallery/thumb/".$delete_image);
