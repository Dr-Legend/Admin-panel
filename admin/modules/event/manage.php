          ...
          <thead>
            <tr class="tbl-head">
              ...
              <th width="32%" class="noPad2"> <a href="<?=$ADMIN->iurl($comp)?>&fld=name<?=(($otype=='asc')?"&otype=desc":'&otype=asc')?>" <?=(($fld=='name')?'class="selectedTab"':'')?>><span <?=(($otype=='asc')?'class="des"':'class="asc"')?>>Title</span></a> </th>
                <th width="20%" class="noPad2"> <a href="<?=$ADMIN->iurl($comp)?>&fld=eventDate<?=(($otype=='asc')?"&otype=desc":'&otype=asc')?>" <?=(($fld=='eventDate')?'class="selectedTab"':'')?>><span <?=(($otype=='asc')?'class="des"':'class="asc"')?>>Event Date</span></a> </th>
             
              <th width="20%" class="noPad2"> <a href="<?=$ADMIN->iurl($comp)?>&fld=eventTime<?=(($otype=='asc')?"&otype=desc":'&otype=asc')?>" <?=(($fld=='eventTime')?'class="selectedTab"':'')?>><span <?=(($otype=='asc')?'class="des"':'class="asc"')?>>Event Time</span></a> </th>
