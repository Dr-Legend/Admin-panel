...
<div class="card mb-3">
  ...
  <div class="card-body">
    ...
    <div class="form-group row border-bottom pb-3">
      <label class="col-12 col-md-3" for="heading">Event Title<span class="text-danger">*</span></label>
   ...
   <div class="form-group row border-bottom pb-3">
      <label class="col-12 col-md-3">Event Date</label>
      <div class="col-12 col-md-9">
      <input type="text" name="eventDate" data-parsley-trigger="change" value="<?=$eventDate?>"  class="form-control datepicker" data-parsley-required-message="Please insert event Date">
      </div>
    </div>
 <div class="form-group row border-bottom pb-3">
      <label class="col-12 col-md-3">Event Time</label>
      <div class="col-12 col-md-9">
      
      <input type="text" name="eventTime" data-parsley-trigger="change" value="<?=$eventTime?>"  class="form-control timepicker" data-parsley-required-message="Please insert event Time">
      </div>
    </div>
    <div class="form-group row border-bottom pb-3">
