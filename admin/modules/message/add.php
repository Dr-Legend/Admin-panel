...
<div class="card mb-3">
  ...
  <div class="card-body">
    ...
    <div class="form-group row border-bottom pb-3">
      <label class="col-12 col-md-3" for="heading">Message Title<span class="text-danger">*</span></label>
   ...
   <div class="form-group row border-bottom pb-3">
      <label class="col-12 col-md-3">Message Date</label>
      <div class="col-12 col-md-9">
      <input type="text" name="messageDate" data-parsley-trigger="change" value="<?=$messageDate?>"  class="form-control datepicker" data-parsley-required-message="Please insert message Date">
      </div>
    </div>
 <div class="form-group row border-bottom pb-3">
      <label class="col-12 col-md-3">Message Time</label>
      <div class="col-12 col-md-9">
      
      <input type="text" name="messageTime" data-parsley-trigger="change" value="<?=$messageTime?>"  class="form-control timepicker" data-parsley-required-message="Please insert message Time">
      </div>
    </div>
    <div class="form-group row border-bottom pb-3">
