...

{
...

	 {
	        ...
	        $query=parent::db_query("select * from #_".tblName." where pagename ='".$pagename."' and subpage_id='".$subpage_id."' "); 
...

	 {
	       ...
	       $query=parent::db_query("select * from #_".tblName." where pagename ='".$pagename."' and pid!='".$updateid."' and subpage_id='".$subpage_id."' "); 
...

	 {
...

		{
		   ...
		   $wh=" and (pagename like '%".$search_data."%' or heading like '%".$search_data."%' or body like '%".$search_data."%') ";	
